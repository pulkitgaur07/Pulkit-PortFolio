...
const Skills = () => {
  const tecks = [
    ...
    { id: 4, src: react, title: "React Js", style: "shadow-blue-500" },
    { id: 5, src: expressjs, title: "Express Js", style: "shadow-yellow-500" },
    { id: 6, src: nodejs, title: "Node Js", style: "shadow-green-500" },
    { id: 7, src: mongodb, title: "Mongo DB", style: "shadow-green-500" },
    { id: 8, src: github, title: "Github", style: "shadow-gray-500" },
    { id: 9, src: tailwindcss, title: "Tailwind CSS", style: "shadow-sky-500" },
    { id: 10, src: cpp, title: "C++", style: "shadow-yellow-500" },
    { id: 11, src: c, title: "C", style: "shadow-blue-500" },
    { id: 12, src: python, title: "Python", style: "shadow-yellow-500" },
  ];

  return (
    <div name="skills" className="w-full bg-gray-100 dark:bg-gray-900">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 sm:px-0">
          {tecks.map(({ id, title, src, style }) => (
            <div
              key={id}
              className={`shadow-md hover:scale-105 duration-300 py-2 rounded-lg ${style} dark:bg-gray-800`}
            >
              <img src={src} alt={title} className="w-20 mx-auto" />
              <p className="mt-4 font-bold text-lg text-gray-900 dark:text-gray-100">
                {title}
              </p>
            </div>
          ))}
